...
const OperationDetails = () => {
  ...
  const handleOpenEditModal = () => {
    setEditFormData({
      ...
      TravalieType: typeTravauxMap[operation.TypeTravauxCode] || 'Travaux',
      BudgetType: typeBudgetMap[operation.TypeBudgetCode] || 'Equipement',
      MethodAttribuation: modeAttribuationMap[operation.ModeAttributionCode] || "Appel d'Offres Ouvert",
  ...
  const handleUpdateOperation = async () => {
    ...
    try {
      ...
      console.log('📤 Sending update data:', {
        ...formData,
        adminID: formData.adminID ? 'Present' : 'Missing'
    });
      ...
      if (result?.success || result?.code === 0) {
        ...
        // On rafraîchit les données pour voir les changements sur la carte
