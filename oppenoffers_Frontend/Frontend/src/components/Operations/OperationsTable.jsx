          ...
          <table className="w-full border-collapse border border-gray-300">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="border border-gray-300 px-4 py-2 text-center text-sm font-semibold text-gray-700">{t('operations.name')}</th>
                ...
                currentOperations.map((op) => (
                  <tr key={op.NumOperation} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="border border-gray-300 px-4 py-2 text-sm">
                      <div>
                        <span className="font-semibold">{t('operations.subject') ?? 'subject'} :</span> {op.Objectif}
                      </div>
                      <div>
                        <span className="font-semibold">{t('operations.service') ?? 'Service'} :</span> {op.ServiceDeContract}
                      </div>
                    </td>
