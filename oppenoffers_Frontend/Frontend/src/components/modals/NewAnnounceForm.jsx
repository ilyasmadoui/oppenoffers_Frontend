    ...
    return (
        <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label className="block text-sm mb-1">Date de Publication <span className="text-red-500">*</span></label>
                    <input
                        type="date"
            ...
            <div className="grid grid-cols-3 gap-4">
                <div>
                    <label className="block text-sm mb-1">Journal <span className="text-red-500">*</span></label>
                    <input
                        type="text"
                ...
                <div>
                    <label className="block text-sm mb-1">Délai <span className="text-red-500">*</span> (jours) </label>
                    <input
                        type="number"
                ...
                <div>
                    <label className="block text-sm mb-1">Date d'ouverture <span className="text-red-500">*</span></label>
                    <input
                        type="date"
            ...
            <div className="grid grid-cols-3 gap-4">
                <div>
                    <label className="block text-sm mb-1">Heure d'ouverture <span className="text-red-500">*</span></label>
                    <input
                        type="time"
