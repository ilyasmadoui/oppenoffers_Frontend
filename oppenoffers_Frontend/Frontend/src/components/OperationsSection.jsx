...
import { getAllSuppliers, newSupplier as addNewSupplierService, updateSupplier as updateSupplierService, deleteSupplier } from '../services/supplierService';
...
const handleAddOperation = async () => {
   ...
   const handleConfirmRetrait = async () => {
    ...
    try {
      if (editingSupplier) {
        ...
        const result = await addNewSupplierService({ ...newSupplier, adminId: user.userId });
  ...
  const handleDeleteSupplier = async (supplierId) => {
    if (!supplierId) {
      showToast('ID du fournisseur manquant', 'error');
      return;
    }
    ...
    try {
      ...
      if (result && result.success) {
        ...
        showToast('Impossible de supprimer le fournisseur', 'error');
      }
    } catch (error) {
