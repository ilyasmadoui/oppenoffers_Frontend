...
export function AnnouncementsTable({ announcements, getOperationNumero, handleOpenModal, handleDeleteAnnouncement , filterStatus = 1}) {
                    ...
                    <td className="border border-gray-300 px-4 py-2 text-center">
                      <div className="flex justify-center items-center gap-3">
                        {isActiveView ? (
                          ...
                          <>
                          <span className="inline-block text-gray-400 font-bold text-lg px-2 select-none" style={{ letterSpacing: "2px" }}>/</span>
                          </>
                        ) }
                      </div>
                    </td>
